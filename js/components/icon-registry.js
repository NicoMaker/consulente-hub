/* ==========================================================================
   ...
   Libreria di icone SVG (stroke, currentColor) condivisa da sito e pannello
   di amministrazione. Espone:
     - ICONS        oggetto { nome: markupSVG }
     - isImageIcon() riconosce se una stringa è un URL/percorso immagine
     - icon(name)    restituisce il markup pronto (SVG o <img>)
   ========================================================================== */
...
const ICONS = {
  ...
  mail: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 6-10 7L2 6"/><rect x="2" y="4" width="20" height="16" rx="2"/></svg>',
  calendar:
  ...
  trend:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M23 6 13.5 15.5l-5-5L1 18"/><path d="M17 6h6v6"/></svg>',
  shield:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',
  umbrella:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 12v8a2 2 0 0 0 4 0"/><path d="M3 12a9 9 0 0 1 18 0Z"/><path d="M12 12V2"/></svg>',
  family:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="7" r="3"/><circle cx="17" cy="8" r="2.3"/><path d="M2 21v-1a6 6 0 0 1 12 0v1"/><path d="M15.5 14a4.2 4.2 0 0 1 6.5 3.5V21"/></svg>',
  ...
  youtube:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22.5 8.5a3 3 0 0 0-2.1-2.1C18.6 6 12 6 12 6s-6.6 0-8.4.4A3 3 0 0 0 1.5 8.5 31 31 0 0 0 1 12a31 31 0 0 0 .5 3.5 3 3 0 0 0 2.1 2.1c1.8.4 8.4.4 8.4.4s6.6 0 8.4-.4a3 3 0 0 0 2.1-2.1A31 31 0 0 0 23 12a31 31 0 0 0-.5-3.5z"/><path d="m10 15 5-3-5-3z"/></svg>',
  arrowRight:
  ...
  arrowLeft:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M19 12H5M11 5l-7 7 7 7"/></svg>',
  externalLink:
  ...
  // --- set esteso, utile per il pannello di amministrazione e nuove aree ---
  coin: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v10M9 9.5c0-1.4 1.3-2.5 3-2.5s3 1 3 2.3-1.3 1.9-3 2.2-3 1-3 2.4 1.3 2.6 3 2.6 3-1 3-2.4"/></svg>',
  ...
  handshake:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m11 17 2 2a2 2 0 1 0 3-3"/><path d="m14 14 2 2a2 2 0 1 0 3-3l-3.5-3.5a2 2 0 0 0-2.8 0l-.7.7a2 2 0 0 1-2.8 0L6 7"/><path d="m21 8-3.5-3.5a2 2 0 0 0-2.8 0L4 15"/><path d="M3 6 8 11l-3.5 3.5"/></svg>',
  star: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2 15 9l7 1-5 5 1.5 7-6.5-3.5L5.5 22 7 15 2 10l7-1z"/></svg>',
  users:
